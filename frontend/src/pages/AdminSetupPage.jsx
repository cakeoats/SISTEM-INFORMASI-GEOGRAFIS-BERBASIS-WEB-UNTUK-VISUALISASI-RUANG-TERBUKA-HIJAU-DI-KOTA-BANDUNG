// src/pages/AdminLoginPage.jsx - Updated dengan setup check dan API integration
...
const AdminLoginPage = () => {
    ...
    // Check if setup required or already logged in
    useEffect(() => {
        checkSetupAndAuth();
    }, []);
    ...
    const checkSetupAndAuth = async () => {
        try {
            ...
            const setupResponse = await axios.get(`${API_BASE_URL}/api/setup/status`);
            if (setupResponse.data.success && setupResponse.data.data.setupRequired) {
